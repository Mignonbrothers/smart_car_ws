...
private:
  ...
  void poseStationaryCallback(const std_msgs::msg::Bool::SharedPtr msg);
  void poseResumeCallback(const std_msgs::msg::Bool::SharedPtr msg);
  void scanCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg);
  void commandCallback(const std_msgs::msg::String::SharedPtr msg);
  void controlLoop();

  double calculateDistanceInDirection(const sensor_msgs::msg::LaserScan & scan, double angle_rad) const;
  double calculateMinDistanceInSector(
    const sensor_msgs::msg::LaserScan & scan,
    double center_angle_rad,
    double half_width_rad) const;
  double calculateAverageDistanceInSector(
    const sensor_msgs::msg::LaserScan & scan,
    double center_angle_rad,
    double half_width_rad) const;
  bool updateObstacleAvoidance(
  ...
  int selectAvoidanceTurnDirection(double left_space_m, double right_space_m) const;
  ...
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr pose_stationary_sub_;
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr pose_resume_sub_;
  ...
  bool pose_stationary_detected_;
  rclcpp::Time pose_stationary_detected_since_;
  rclcpp::Time last_pose_stationary_time_;
  bool pose_stop_latched_;
  bool obstacle_avoidance_active_;
  int avoidance_turn_direction_;
  int wall_follow_side_;
  rclcpp::Time obstacle_avoidance_started_time_;
  rclcpp::Time front_clear_since_time_;
  ...
  double pose_stationary_hold_s_;
  double pose_stationary_timeout_s_;
  bool obstacle_avoidance_enabled_;
  double obstacle_trigger_distance_m_;
  double obstacle_front_half_width_rad_;
  ...
  double obstacle_alignment_tolerance_rad_;
  double wall_follow_linear_velocity_;
  double wall_follow_angular_velocity_;
  double wall_follow_target_distance_m_;
  double wall_follow_kp_;
  std::string detection_topic_;
  std::string pan_angle_topic_;
  std::string pose_stationary_topic_;
  std::string pose_resume_topic_;
